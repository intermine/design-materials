    ...
    <div id="footer">
      <!--
      <span id="footersitetitle">
        <a href="<?php echo get_settings('home'); ?>/" title="<?php echo get_settings('home'); ?>"><?php bloginfo('name'); ?></a>
      </span>
      -->

      <a href="http://www.genome.gov/" title="National Human Genome Research Institute">
        <img src="wp-content/themes/flymine/images/nhgri-logo.png" alt="NHGRI" />
      </a>
      &nbsp;&nbsp;
      <a href="http://www.cam.ac.uk/" title="University of Cambridge">
        <img src="wp-content/themes/flymine/images/cam-logo.png" alt="Cambridge University" />
      </a>

      <p>
            <a href="http://www.intermine.org/">InterMine</a>
            <span>|</span>
            <a href="http://www.metabolicmine.org/">metabolicMine</a>
            <span>|</span>
